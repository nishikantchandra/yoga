        ...
        >
          <div className="flex items-center gap-3">
            <button
              ...
              className="w-10 h-10 rounded-xl bg-white/80 dark:bg-gray-800/80 border border-pink-200 dark:border-gray-700 hover:bg-pink-50 dark:hover:bg-gray-700 flex items-center justify-center transition-all"
              title="Back to Home"
            >
